...
yum install -y libnvme-devel golang librdmacm rdma-core libnuma-devel ncurses-devel nvme-cli nvmetcli
...
yum install -y librdmacm rdma-core-devel fuse3-devel meson
