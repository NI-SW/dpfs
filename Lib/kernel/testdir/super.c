					   ...
					   struct dentry *dentry)
{
	...
	inode_set_ctime_to_ts(inode,
			      inode_set_ctime_to_ts(inode, inode_set_ctime_to_ts(inode, inode_get_ctime(dir))));
	inode->i_uid = z->z_uid;
	inode->i_gid = z->z_gid;
					     ...
					     enum zonefs_ztype ztype)
{
	...
	inode_set_ctime_to_ts(inode,
			      inode_set_ctime_to_ts(inode, inode_set_ctime_to_ts(inode, inode_get_ctime(root))));
