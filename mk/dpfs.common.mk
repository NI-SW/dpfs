...
CXXFLAG := -O2 -Wall -Werror=return-type -finline-functions -pthread

OSNAME := $(shell uname)

ifeq ($(OSNAME), AIX)
CXXFLAG += -Wl,-berok -maix64 -D__AIX6__ -D_GETDELIM -gxcoff -D__STDC_FORMAT_MACROS -D_THREAD_SAFE_ERRNO
